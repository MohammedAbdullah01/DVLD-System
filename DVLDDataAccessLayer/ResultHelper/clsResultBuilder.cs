...
namespace DVLDDataAccessLayer.Result_Helper
{
    public static class clsResultBuilder
    {
        ...
        public static clsPersonAddressResult BuildPersonAddressResult(clsPersonAddressInfo PersonAddresse, string message)
        {
            return new clsPersonAddressResult
            {
                Found = PersonAddresse != null,
                PersonAddresse = PersonAddresse,
                GetMessage = PersonAddresse != null
                    ? Message.FromSuccess(message)
                    : Message.FromError(message)
            };
